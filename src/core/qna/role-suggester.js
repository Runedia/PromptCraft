...
function suggestRoles(scanResult) {
  ...
  if (hasAny(frameworks, ['react']) && !hasAny(frameworks, ['next'])) add('React 프론트엔드 개발자');
  ...
  if (hasAny(languages, ['python']) && !hasAny(frameworks, ['fastapi', 'django'])) add('Python 개발자');
