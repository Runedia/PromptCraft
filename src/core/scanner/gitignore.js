 ...
 */
function toGlobIgnorePatterns(ignoreRules) {
 ...
 * @returns {boolean}
 */
function shouldIgnore(ignoreRules, relativePath) {
  return ignoreRules.ig.ignores(relativePath);
}

module.exports = { loadIgnoreRules, toGlobIgnorePatterns, shouldIgnore, DEFAULT_IGNORE_DIRS };
